...
- Унарные операторы - тригонометрические функции (sin, cos, tan), квадратный корень (√), отрицание (-), квадрат (x²), куб (x³), факториал (!)
- Бинарные операторы - арифметические примитивы
- Константы - вставка констант (φ, τ, √2, γ, π, e)
